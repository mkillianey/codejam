...
public class SolutionRunner {
  ...
  var _newLine : String
  var _solver : block(BufferedReader) : String

  private construct(solver : block(BufferedReader) : String) {
   ...
   */
  static public function from(solver : block(BufferedReader) : String) : SolutionRunner {
